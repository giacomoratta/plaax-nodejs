...
exports.assertHttpStatusCodeIsValid = exports.InvalidHttpStatusCode = exports.HttpStatusCode = void 0;
/**
...
(function (HttpStatusCode) {
    ...
    /**
     * The requested resource is capable of generating only content not acceptable according to theAccept headers sent
     * in the request.
     */
...
var InvalidHttpStatusCode = /** @class */ (function (_super) {
    __extends(InvalidHttpStatusCode, _super);
    function InvalidHttpStatusCode(invalidCode) {
        return _super.call(this, "Invalid Http Status Code: ".concat(invalidCode, ". Use or check 'HttpStatusCode' type definition.")) || this;
    }
    return InvalidHttpStatusCode;
}(Error));
exports.InvalidHttpStatusCode = InvalidHttpStatusCode;
var assertHttpStatusCodeIsValid = function (statusCode) {
    if (HttpStatusCode[statusCode] === undefined) {
        throw new InvalidHttpStatusCode(statusCode);
    }
};
exports.assertHttpStatusCodeIsValid = assertHttpStatusCodeIsValid;

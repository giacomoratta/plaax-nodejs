...
export class InvalidHttpStatusCode extends Error {
  constructor (invalidCode: string | number) {
    super(`Invalid Http Status Code: ${invalidCode}. Use or check 'HttpStatusCode' type definition.`)
  }
}

export const assertHttpStatusCodeIsValid = (statusCode: HttpStatusCode): void => {

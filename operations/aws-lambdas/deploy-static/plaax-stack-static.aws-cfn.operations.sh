...
then
  ...
  --template-file ./operations/aws-lambdas/deploy-static/plaax-stack-static.aws-cfn.yml \
...
then
  ...
  plaaxUniqueIdsFiles=( ../operations/aws-lambdas/deploy-static/initial-static-data/plaax-unique-ids/*.json )

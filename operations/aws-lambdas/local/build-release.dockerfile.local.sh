...
then
  docker build \
    ...
    -f ./operations/aws-lambdas/build-release/all-steps.dockerfile .
...
# 1 dir-levels behind:  docker build -t gr/plaax-nodejs/build-release -f ./operations/aws-lambdas/build-release.dockerfile .
